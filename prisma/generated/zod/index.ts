...
export const ProductDetailScalarFieldEnumSchema = z.enum(['id','product_id','description','short_description','bar_code','ingredient','manufacturing_country','manufacturer','how_to_use','createdAt','updatedAt']);
