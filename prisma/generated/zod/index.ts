...
export const UserScalarFieldEnumSchema = z.enum(['id','name','email','emailVerified','image','sex','password','date_of_birth','role','createdAt','updatedAt']);

export const VerificationTokenScalarFieldEnumSchema = z.enum(['identifier','token','expires']);

export const PasswordResetScalarFieldEnumSchema = z.enum(['id','user_id','token','created_at','updated_at']);

export const AddressScalarFieldEnumSchema = z.enum(['id','name','phone_number','address_detail','type_address','created_at','updated_at','province_id','district_id','wardsWards_id','userId']);
...
export const WardsScalarFieldEnumSchema = z.enum(['wards_id','district_id','name']);

export const UnitScalarFieldEnumSchema = z.enum(['id','name','createdAt','updatedAt']);

export const ProductScalarFieldEnumSchema = z.enum(['id','name','price','description','short_description','unit_id','createdAt','updatedAt','quantity','expiryProduct','brand_origin_id','category_id','brand_name_id']);

export const ImageProductScalarFieldEnumSchema = z.enum(['id','url','product_id','createdAt','updatedAt']);

export const BrandOriginScalarFieldEnumSchema = z.enum(['id','name','createdAt','updatedAt']);

export const CategoryScalarFieldEnumSchema = z.enum(['id','name','createdAt','updatedAt']);

export const BrandNameScalarFieldEnumSchema = z.enum(['id','name','createdAt','updatedAt']);

export const CartScalarFieldEnumSchema = z.enum(['id','user_id','product_id','quantity','createdAt','updatedAt']);

export const OrderScalarFieldEnumSchema = z.enum(['id','user_id','product_id','quantity','createdAt','updatedAt','status_order_id']);
...
export const WardsSchema = z.object({
  wards_id: z.string().cuid(),
  district_id: z.string(),
  name: z.string(),
})

export type Wards = z.infer<typeof WardsSchema>
...
export const ProductSchema = z.object({
  ...
  expiryProduct: z.coerce.date(),
  brand_origin_id: z.string().nullable(),
  category_id: z.string().nullable(),
  brand_name_id: z.string().nullable(),
})
...
export const BrandOriginSchema = z.object({
  id: z.string().cuid(),
  name: z.string(),
  createdAt: z.coerce.date(),
  updatedAt: z.coerce.date(),
...
export type BrandOrigin = z.infer<typeof BrandOriginSchema>
...
export const AddressIncludeSchema: z.ZodType<Prisma.AddressInclude> = z.object({
  ...
  wards: z.union([z.boolean(),z.lazy(() => WardsArgsSchema)]).optional(),
  User: z.union([z.boolean(),z.lazy(() => UserArgsSchema)]).optional(),
}).strict()
...
export const AddressSelectSchema: z.ZodType<Prisma.AddressSelect> = z.object({
  ...
  wardsWards_id: z.boolean().optional(),
  userId: z.boolean().optional(),
  province: z.union([z.boolean(),z.lazy(() => ProvinceArgsSchema)]).optional(),
  district: z.union([z.boolean(),z.lazy(() => DistrictArgsSchema)]).optional(),
  wards: z.union([z.boolean(),z.lazy(() => WardsArgsSchema)]).optional(),
...
export const DistrictIncludeSchema: z.ZodType<Prisma.DistrictInclude> = z.object({
  Province: z.union([z.boolean(),z.lazy(() => ProvinceArgsSchema)]).optional(),
  Ward: z.union([z.boolean(),z.lazy(() => WardsFindManyArgsSchema)]).optional(),
  Address: z.union([z.boolean(),z.lazy(() => AddressFindManyArgsSchema)]).optional(),
...
export const WardsIncludeSchema: z.ZodType<Prisma.WardsInclude> = z.object({
  District: z.union([z.boolean(),z.lazy(() => DistrictArgsSchema)]).optional(),
  Address: z.union([z.boolean(),z.lazy(() => AddressFindManyArgsSchema)]).optional(),
  _count: z.union([z.boolean(),z.lazy(() => WardsCountOutputTypeArgsSchema)]).optional(),
}).strict()

export const WardsArgsSchema: z.ZodType<Prisma.WardsDefaultArgs> = z.object({
  select: z.lazy(() => WardsSelectSchema).optional(),
  include: z.lazy(() => WardsIncludeSchema).optional(),
}).strict();

export const WardsCountOutputTypeArgsSchema: z.ZodType<Prisma.WardsCountOutputTypeDefaultArgs> = z.object({
  select: z.lazy(() => WardsCountOutputTypeSelectSchema).nullish(),
}).strict();

export const WardsCountOutputTypeSelectSchema: z.ZodType<Prisma.WardsCountOutputTypeSelect> = z.object({
  Address: z.boolean().optional(),
}).strict();

export const WardsSelectSchema: z.ZodType<Prisma.WardsSelect> = z.object({
  wards_id: z.boolean().optional(),
  district_id: z.boolean().optional(),
  name: z.boolean().optional(),
  District: z.union([z.boolean(),z.lazy(() => DistrictArgsSchema)]).optional(),
  Address: z.union([z.boolean(),z.lazy(() => AddressFindManyArgsSchema)]).optional(),
...
export const ProductIncludeSchema: z.ZodType<Prisma.ProductInclude> = z.object({
  ...
  BrandOrigin: z.union([z.boolean(),z.lazy(() => BrandOriginArgsSchema)]).optional(),
  Category: z.union([z.boolean(),z.lazy(() => CategoryArgsSchema)]).optional(),
  BrandName: z.union([z.boolean(),z.lazy(() => BrandNameArgsSchema)]).optional(),
  Cart: z.union([z.boolean(),z.lazy(() => CartFindManyArgsSchema)]).optional(),
  order: z.union([z.boolean(),z.lazy(() => OrderFindManyArgsSchema)]).optional(),
...
export const ProductSelectSchema: z.ZodType<Prisma.ProductSelect> = z.object({
  ...
  expiryProduct: z.boolean().optional(),
  brand_origin_id: z.boolean().optional(),
  category_id: z.boolean().optional(),
  brand_name_id: z.boolean().optional(),
  image: z.union([z.boolean(),z.lazy(() => ImageProductFindManyArgsSchema)]).optional(),
  unit: z.union([z.boolean(),z.lazy(() => UnitArgsSchema)]).optional(),
  BrandOrigin: z.union([z.boolean(),z.lazy(() => BrandOriginArgsSchema)]).optional(),
  Category: z.union([z.boolean(),z.lazy(() => CategoryArgsSchema)]).optional(),
...
export const BrandOriginIncludeSchema: z.ZodType<Prisma.BrandOriginInclude> = z.object({
  Product: z.union([z.boolean(),z.lazy(() => ProductFindManyArgsSchema)]).optional(),
  _count: z.union([z.boolean(),z.lazy(() => BrandOriginCountOutputTypeArgsSchema)]).optional(),
}).strict()

export const BrandOriginArgsSchema: z.ZodType<Prisma.BrandOriginDefaultArgs> = z.object({
  select: z.lazy(() => BrandOriginSelectSchema).optional(),
  include: z.lazy(() => BrandOriginIncludeSchema).optional(),
}).strict();

export const BrandOriginCountOutputTypeArgsSchema: z.ZodType<Prisma.BrandOriginCountOutputTypeDefaultArgs> = z.object({
  select: z.lazy(() => BrandOriginCountOutputTypeSelectSchema).nullish(),
}).strict();

export const BrandOriginCountOutputTypeSelectSchema: z.ZodType<Prisma.BrandOriginCountOutputTypeSelect> = z.object({
  Product: z.boolean().optional(),
}).strict();

export const BrandOriginSelectSchema: z.ZodType<Prisma.BrandOriginSelect> = z.object({
  id: z.boolean().optional(),
  name: z.boolean().optional(),
  createdAt: z.boolean().optional(),
  updatedAt: z.boolean().optional(),
...
export const BrandNameIncludeSchema: z.ZodType<Prisma.BrandNameInclude> = z.object({
  Product: z.union([z.boolean(),z.lazy(() => ProductFindManyArgsSchema)]).optional(),
  _count: z.union([z.boolean(),z.lazy(() => BrandNameCountOutputTypeArgsSchema)]).optional(),
}).strict()

export const BrandNameArgsSchema: z.ZodType<Prisma.BrandNameDefaultArgs> = z.object({
  select: z.lazy(() => BrandNameSelectSchema).optional(),
  include: z.lazy(() => BrandNameIncludeSchema).optional(),
}).strict();

export const BrandNameCountOutputTypeArgsSchema: z.ZodType<Prisma.BrandNameCountOutputTypeDefaultArgs> = z.object({
  select: z.lazy(() => BrandNameCountOutputTypeSelectSchema).nullish(),
}).strict();

export const BrandNameCountOutputTypeSelectSchema: z.ZodType<Prisma.BrandNameCountOutputTypeSelect> = z.object({
  Product: z.boolean().optional(),
}).strict();

export const BrandNameSelectSchema: z.ZodType<Prisma.BrandNameSelect> = z.object({
  id: z.boolean().optional(),
  name: z.boolean().optional(),
  createdAt: z.boolean().optional(),
  updatedAt: z.boolean().optional(),
...
export const AddressWhereInputSchema: z.ZodType<Prisma.AddressWhereInput> = z.object({
  ...
  wardsWards_id: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  userId: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  province: z.union([ z.lazy(() => ProvinceRelationFilterSchema),z.lazy(() => ProvinceWhereInputSchema) ]).optional(),
  district: z.union([ z.lazy(() => DistrictRelationFilterSchema),z.lazy(() => DistrictWhereInputSchema) ]).optional(),
  wards: z.union([ z.lazy(() => WardsRelationFilterSchema),z.lazy(() => WardsWhereInputSchema) ]).optional(),
...
export const AddressOrderByWithRelationInputSchema: z.ZodType<Prisma.AddressOrderByWithRelationInput> = z.object({
  ...
  wardsWards_id: z.lazy(() => SortOrderSchema).optional(),
  ...
  wards: z.lazy(() => WardsOrderByWithRelationInputSchema).optional(),
  User: z.lazy(() => UserOrderByWithRelationInputSchema).optional()
}).strict();
...
export const AddressScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.AddressScalarWhereWithAggregatesInput> = z.object({
  ...
  wardsWards_id: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
...
export const DistrictWhereInputSchema: z.ZodType<Prisma.DistrictWhereInput> = z.object({
  ...
  province_id: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  name: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  Province: z.union([ z.lazy(() => ProvinceNullableRelationFilterSchema),z.lazy(() => ProvinceWhereInputSchema) ]).optional().nullable(),
  Ward: z.lazy(() => WardsListRelationFilterSchema).optional(),
  Address: z.lazy(() => AddressListRelationFilterSchema).optional()
}).strict();
...
export const DistrictOrderByWithRelationInputSchema: z.ZodType<Prisma.DistrictOrderByWithRelationInput> = z.object({
  ...
  name: z.lazy(() => SortOrderSchema).optional(),
  Province: z.lazy(() => ProvinceOrderByWithRelationInputSchema).optional(),
  Ward: z.lazy(() => WardsOrderByRelationAggregateInputSchema).optional(),
  Address: z.lazy(() => AddressOrderByRelationAggregateInputSchema).optional()
}).strict();
...
export const WardsWhereInputSchema: z.ZodType<Prisma.WardsWhereInput> = z.object({
  AND: z.union([ z.lazy(() => WardsWhereInputSchema),z.lazy(() => WardsWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => WardsWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => WardsWhereInputSchema),z.lazy(() => WardsWhereInputSchema).array() ]).optional(),
  wards_id: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  district_id: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  name: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  District: z.union([ z.lazy(() => DistrictNullableRelationFilterSchema),z.lazy(() => DistrictWhereInputSchema) ]).optional().nullable(),
  Address: z.lazy(() => AddressListRelationFilterSchema).optional()
}).strict();

export const WardsOrderByWithRelationInputSchema: z.ZodType<Prisma.WardsOrderByWithRelationInput> = z.object({
  wards_id: z.lazy(() => SortOrderSchema).optional(),
  district_id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional(),
  District: z.lazy(() => DistrictOrderByWithRelationInputSchema).optional(),
  Address: z.lazy(() => AddressOrderByRelationAggregateInputSchema).optional()
...
export const WardsWhereUniqueInputSchema: z.ZodType<Prisma.WardsWhereUniqueInput> = z.object({
  wards_id: z.string().cuid()
})
.and(z.object({
  wards_id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => WardsWhereInputSchema),z.lazy(() => WardsWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => WardsWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => WardsWhereInputSchema),z.lazy(() => WardsWhereInputSchema).array() ]).optional(),
  district_id: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
...
export const WardsOrderByWithAggregationInputSchema: z.ZodType<Prisma.WardsOrderByWithAggregationInput> = z.object({
  wards_id: z.lazy(() => SortOrderSchema).optional(),
  district_id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional(),
  _count: z.lazy(() => WardsCountOrderByAggregateInputSchema).optional(),
  _max: z.lazy(() => WardsMaxOrderByAggregateInputSchema).optional(),
  _min: z.lazy(() => WardsMinOrderByAggregateInputSchema).optional()
}).strict();

export const WardsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.WardsScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => WardsScalarWhereWithAggregatesInputSchema),z.lazy(() => WardsScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => WardsScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => WardsScalarWhereWithAggregatesInputSchema),z.lazy(() => WardsScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  wards_id: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  district_id: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  name: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
}).strict();
...
export const ProductWhereInputSchema: z.ZodType<Prisma.ProductWhereInput> = z.object({
  ...
  expiryProduct: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  brand_origin_id: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  category_id: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  brand_name_id: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  BrandOrigin: z.union([ z.lazy(() => BrandOriginNullableRelationFilterSchema),z.lazy(() => BrandOriginWhereInputSchema) ]).optional().nullable(),
  Category: z.union([ z.lazy(() => CategoryNullableRelationFilterSchema),z.lazy(() => CategoryWhereInputSchema) ]).optional().nullable(),
  BrandName: z.union([ z.lazy(() => BrandNameNullableRelationFilterSchema),z.lazy(() => BrandNameWhereInputSchema) ]).optional().nullable(),
  Cart: z.lazy(() => CartListRelationFilterSchema).optional(),
  order: z.lazy(() => OrderListRelationFilterSchema).optional()
}).strict();
...
export const ProductOrderByWithRelationInputSchema: z.ZodType<Prisma.ProductOrderByWithRelationInput> = z.object({
  ...
  expiryProduct: z.lazy(() => SortOrderSchema).optional(),
  brand_origin_id: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
  category_id: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
  brand_name_id: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
  ...
  BrandOrigin: z.lazy(() => BrandOriginOrderByWithRelationInputSchema).optional(),
  Category: z.lazy(() => CategoryOrderByWithRelationInputSchema).optional(),
  BrandName: z.lazy(() => BrandNameOrderByWithRelationInputSchema).optional(),
  Cart: z.lazy(() => CartOrderByRelationAggregateInputSchema).optional(),
  order: z.lazy(() => OrderOrderByRelationAggregateInputSchema).optional()
}).strict();
...
export const ProductScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.ProductScalarWhereWithAggregatesInput> = z.object({
  ...
  expiryProduct: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
  brand_origin_id: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  category_id: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  brand_name_id: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
}).strict();
...
export const BrandOriginWhereInputSchema: z.ZodType<Prisma.BrandOriginWhereInput> = z.object({
  AND: z.union([ z.lazy(() => BrandOriginWhereInputSchema),z.lazy(() => BrandOriginWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => BrandOriginWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => BrandOriginWhereInputSchema),z.lazy(() => BrandOriginWhereInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  name: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  createdAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
...
export const BrandOriginOrderByWithRelationInputSchema: z.ZodType<Prisma.BrandOriginOrderByWithRelationInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional(),
  createdAt: z.lazy(() => SortOrderSchema).optional(),
  updatedAt: z.lazy(() => SortOrderSchema).optional(),
...
export const BrandOriginWhereUniqueInputSchema: z.ZodType<Prisma.BrandOriginWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
...
export const BrandOriginOrderByWithAggregationInputSchema: z.ZodType<Prisma.BrandOriginOrderByWithAggregationInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional(),
  createdAt: z.lazy(() => SortOrderSchema).optional(),
  updatedAt: z.lazy(() => SortOrderSchema).optional(),
  _count: z.lazy(() => BrandOriginCountOrderByAggregateInputSchema).optional(),
  _max: z.lazy(() => BrandOriginMaxOrderByAggregateInputSchema).optional(),
  _min: z.lazy(() => BrandOriginMinOrderByAggregateInputSchema).optional()
}).strict();

export const BrandOriginScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.BrandOriginScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => BrandOriginScalarWhereWithAggregatesInputSchema),z.lazy(() => BrandOriginScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => BrandOriginScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => BrandOriginScalarWhereWithAggregatesInputSchema),z.lazy(() => BrandOriginScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  name: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  createdAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
...
export const BrandNameWhereInputSchema: z.ZodType<Prisma.BrandNameWhereInput> = z.object({
  AND: z.union([ z.lazy(() => BrandNameWhereInputSchema),z.lazy(() => BrandNameWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => BrandNameWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => BrandNameWhereInputSchema),z.lazy(() => BrandNameWhereInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  name: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  createdAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
...
export const BrandNameOrderByWithRelationInputSchema: z.ZodType<Prisma.BrandNameOrderByWithRelationInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional(),
  createdAt: z.lazy(() => SortOrderSchema).optional(),
  updatedAt: z.lazy(() => SortOrderSchema).optional(),
...
export const BrandNameWhereUniqueInputSchema: z.ZodType<Prisma.BrandNameWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
...
export const BrandNameOrderByWithAggregationInputSchema: z.ZodType<Prisma.BrandNameOrderByWithAggregationInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional(),
  createdAt: z.lazy(() => SortOrderSchema).optional(),
  updatedAt: z.lazy(() => SortOrderSchema).optional(),
  _count: z.lazy(() => BrandNameCountOrderByAggregateInputSchema).optional(),
  _max: z.lazy(() => BrandNameMaxOrderByAggregateInputSchema).optional(),
  _min: z.lazy(() => BrandNameMinOrderByAggregateInputSchema).optional()
}).strict();

export const BrandNameScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.BrandNameScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => BrandNameScalarWhereWithAggregatesInputSchema),z.lazy(() => BrandNameScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => BrandNameScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => BrandNameScalarWhereWithAggregatesInputSchema),z.lazy(() => BrandNameScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  name: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  createdAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
...
export const AddressCreateInputSchema: z.ZodType<Prisma.AddressCreateInput> = z.object({
  ...
  created_at: z.coerce.date().optional(),
  updated_at: z.coerce.date().optional(),
  province: z.lazy(() => ProvinceCreateNestedOneWithoutAddressInputSchema),
  district: z.lazy(() => DistrictCreateNestedOneWithoutAddressInputSchema),
  wards: z.lazy(() => WardsCreateNestedOneWithoutAddressInputSchema),
...
export const AddressUpdateInputSchema: z.ZodType<Prisma.AddressUpdateInput> = z.object({
  ...
  created_at: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updated_at: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  province: z.lazy(() => ProvinceUpdateOneRequiredWithoutAddressNestedInputSchema).optional(),
  district: z.lazy(() => DistrictUpdateOneRequiredWithoutAddressNestedInputSchema).optional(),
  wards: z.lazy(() => WardsUpdateOneRequiredWithoutAddressNestedInputSchema).optional(),
...
export const AddressUncheckedUpdateInputSchema: z.ZodType<Prisma.AddressUncheckedUpdateInput> = z.object({
  ...
  wardsWards_id: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const DistrictCreateInputSchema: z.ZodType<Prisma.DistrictCreateInput> = z.object({
  ...
  Ward: z.lazy(() => WardsCreateNestedManyWithoutDistrictInputSchema).optional(),
...
export const DistrictUncheckedCreateInputSchema: z.ZodType<Prisma.DistrictUncheckedCreateInput> = z.object({
  ...
  province_id: z.string(),
  name: z.string(),
  Ward: z.lazy(() => WardsUncheckedCreateNestedManyWithoutDistrictInputSchema).optional(),
...
export const DistrictUpdateInputSchema: z.ZodType<Prisma.DistrictUpdateInput> = z.object({
  ...
  Ward: z.lazy(() => WardsUpdateManyWithoutDistrictNestedInputSchema).optional(),
...
export const DistrictUncheckedUpdateInputSchema: z.ZodType<Prisma.DistrictUncheckedUpdateInput> = z.object({
  ...
  province_id: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  Ward: z.lazy(() => WardsUncheckedUpdateManyWithoutDistrictNestedInputSchema).optional(),
...
export const WardsCreateInputSchema: z.ZodType<Prisma.WardsCreateInput> = z.object({
  wards_id: z.string().cuid().optional(),
  name: z.string(),
  District: z.lazy(() => DistrictCreateNestedOneWithoutWardInputSchema).optional(),
  Address: z.lazy(() => AddressCreateNestedManyWithoutWardsInputSchema).optional()
}).strict();

export const WardsUncheckedCreateInputSchema: z.ZodType<Prisma.WardsUncheckedCreateInput> = z.object({
  wards_id: z.string().cuid().optional(),
  district_id: z.string(),
  name: z.string(),
  Address: z.lazy(() => AddressUncheckedCreateNestedManyWithoutWardsInputSchema).optional()
}).strict();

export const WardsUpdateInputSchema: z.ZodType<Prisma.WardsUpdateInput> = z.object({
  wards_id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  District: z.lazy(() => DistrictUpdateOneWithoutWardNestedInputSchema).optional(),
  Address: z.lazy(() => AddressUpdateManyWithoutWardsNestedInputSchema).optional()
}).strict();

export const WardsUncheckedUpdateInputSchema: z.ZodType<Prisma.WardsUncheckedUpdateInput> = z.object({
  wards_id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  district_id: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  Address: z.lazy(() => AddressUncheckedUpdateManyWithoutWardsNestedInputSchema).optional()
}).strict();

export const WardsCreateManyInputSchema: z.ZodType<Prisma.WardsCreateManyInput> = z.object({
  wards_id: z.string().cuid().optional(),
  district_id: z.string(),
  name: z.string()
}).strict();

export const WardsUpdateManyMutationInputSchema: z.ZodType<Prisma.WardsUpdateManyMutationInput> = z.object({
  wards_id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();

export const WardsUncheckedUpdateManyInputSchema: z.ZodType<Prisma.WardsUncheckedUpdateManyInput> = z.object({
  wards_id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  district_id: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();
...
export const ProductCreateInputSchema: z.ZodType<Prisma.ProductCreateInput> = z.object({
  ...
  BrandOrigin: z.lazy(() => BrandOriginCreateNestedOneWithoutProductInputSchema).optional(),
  Category: z.lazy(() => CategoryCreateNestedOneWithoutProductInputSchema).optional(),
  BrandName: z.lazy(() => BrandNameCreateNestedOneWithoutProductInputSchema).optional(),
...
export const ProductUncheckedCreateInputSchema: z.ZodType<Prisma.ProductUncheckedCreateInput> = z.object({
  ...
  quantity: z.number().int(),
  expiryProduct: z.coerce.date(),
  brand_origin_id: z.string().optional().nullable(),
  category_id: z.string().optional().nullable(),
  brand_name_id: z.string().optional().nullable(),
...
export const ProductUpdateInputSchema: z.ZodType<Prisma.ProductUpdateInput> = z.object({
  ...
  expiryProduct: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  ...
  BrandOrigin: z.lazy(() => BrandOriginUpdateOneWithoutProductNestedInputSchema).optional(),
  Category: z.lazy(() => CategoryUpdateOneWithoutProductNestedInputSchema).optional(),
  BrandName: z.lazy(() => BrandNameUpdateOneWithoutProductNestedInputSchema).optional(),
...
export const ProductUncheckedUpdateInputSchema: z.ZodType<Prisma.ProductUncheckedUpdateInput> = z.object({
  ...
  quantity: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  expiryProduct: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  brand_origin_id: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  category_id: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  brand_name_id: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const BrandOriginCreateInputSchema: z.ZodType<Prisma.BrandOriginCreateInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  Product: z.lazy(() => ProductCreateNestedManyWithoutBrandOriginInputSchema).optional()
}).strict();

export const BrandOriginUncheckedCreateInputSchema: z.ZodType<Prisma.BrandOriginUncheckedCreateInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  Product: z.lazy(() => ProductUncheckedCreateNestedManyWithoutBrandOriginInputSchema).optional()
}).strict();

export const BrandOriginUpdateInputSchema: z.ZodType<Prisma.BrandOriginUpdateInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  Product: z.lazy(() => ProductUpdateManyWithoutBrandOriginNestedInputSchema).optional()
}).strict();

export const BrandOriginUncheckedUpdateInputSchema: z.ZodType<Prisma.BrandOriginUncheckedUpdateInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  Product: z.lazy(() => ProductUncheckedUpdateManyWithoutBrandOriginNestedInputSchema).optional()
}).strict();

export const BrandOriginCreateManyInputSchema: z.ZodType<Prisma.BrandOriginCreateManyInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional()
...
export const BrandOriginUpdateManyMutationInputSchema: z.ZodType<Prisma.BrandOriginUpdateManyMutationInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const BrandOriginUncheckedUpdateManyInputSchema: z.ZodType<Prisma.BrandOriginUncheckedUpdateManyInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const BrandNameCreateInputSchema: z.ZodType<Prisma.BrandNameCreateInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  Product: z.lazy(() => ProductCreateNestedManyWithoutBrandNameInputSchema).optional()
}).strict();

export const BrandNameUncheckedCreateInputSchema: z.ZodType<Prisma.BrandNameUncheckedCreateInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  Product: z.lazy(() => ProductUncheckedCreateNestedManyWithoutBrandNameInputSchema).optional()
}).strict();

export const BrandNameUpdateInputSchema: z.ZodType<Prisma.BrandNameUpdateInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  Product: z.lazy(() => ProductUpdateManyWithoutBrandNameNestedInputSchema).optional()
}).strict();

export const BrandNameUncheckedUpdateInputSchema: z.ZodType<Prisma.BrandNameUncheckedUpdateInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  Product: z.lazy(() => ProductUncheckedUpdateManyWithoutBrandNameNestedInputSchema).optional()
}).strict();

export const BrandNameCreateManyInputSchema: z.ZodType<Prisma.BrandNameCreateManyInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional()
...
export const BrandNameUpdateManyMutationInputSchema: z.ZodType<Prisma.BrandNameUpdateManyMutationInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const BrandNameUncheckedUpdateManyInputSchema: z.ZodType<Prisma.BrandNameUncheckedUpdateManyInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const WardsRelationFilterSchema: z.ZodType<Prisma.WardsRelationFilter> = z.object({
  is: z.lazy(() => WardsWhereInputSchema).optional(),
  isNot: z.lazy(() => WardsWhereInputSchema).optional()
}).strict();
...
export const ProvinceNullableRelationFilterSchema: z.ZodType<Prisma.ProvinceNullableRelationFilter> = z.object({
  is: z.lazy(() => ProvinceWhereInputSchema).optional().nullable(),
  isNot: z.lazy(() => ProvinceWhereInputSchema).optional().nullable()
}).strict();

export const WardsListRelationFilterSchema: z.ZodType<Prisma.WardsListRelationFilter> = z.object({
  every: z.lazy(() => WardsWhereInputSchema).optional(),
  some: z.lazy(() => WardsWhereInputSchema).optional(),
  none: z.lazy(() => WardsWhereInputSchema).optional()
}).strict();

export const WardsOrderByRelationAggregateInputSchema: z.ZodType<Prisma.WardsOrderByRelationAggregateInput> = z.object({
  _count: z.lazy(() => SortOrderSchema).optional()
}).strict();
...
export const DistrictNullableRelationFilterSchema: z.ZodType<Prisma.DistrictNullableRelationFilter> = z.object({
  is: z.lazy(() => DistrictWhereInputSchema).optional().nullable(),
  isNot: z.lazy(() => DistrictWhereInputSchema).optional().nullable()
}).strict();

export const WardsCountOrderByAggregateInputSchema: z.ZodType<Prisma.WardsCountOrderByAggregateInput> = z.object({
  wards_id: z.lazy(() => SortOrderSchema).optional(),
  district_id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional()
}).strict();

export const WardsMaxOrderByAggregateInputSchema: z.ZodType<Prisma.WardsMaxOrderByAggregateInput> = z.object({
  wards_id: z.lazy(() => SortOrderSchema).optional(),
  district_id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional()
}).strict();

export const WardsMinOrderByAggregateInputSchema: z.ZodType<Prisma.WardsMinOrderByAggregateInput> = z.object({
  wards_id: z.lazy(() => SortOrderSchema).optional(),
  district_id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional()
}).strict();
...
export const BrandOriginNullableRelationFilterSchema: z.ZodType<Prisma.BrandOriginNullableRelationFilter> = z.object({
  is: z.lazy(() => BrandOriginWhereInputSchema).optional().nullable(),
  isNot: z.lazy(() => BrandOriginWhereInputSchema).optional().nullable()
}).strict();
...
export const BrandNameNullableRelationFilterSchema: z.ZodType<Prisma.BrandNameNullableRelationFilter> = z.object({
  is: z.lazy(() => BrandNameWhereInputSchema).optional().nullable(),
  isNot: z.lazy(() => BrandNameWhereInputSchema).optional().nullable()
}).strict();
...
export const ProductCountOrderByAggregateInputSchema: z.ZodType<Prisma.ProductCountOrderByAggregateInput> = z.object({
  ...
  quantity: z.lazy(() => SortOrderSchema).optional(),
  expiryProduct: z.lazy(() => SortOrderSchema).optional(),
  brand_origin_id: z.lazy(() => SortOrderSchema).optional(),
  category_id: z.lazy(() => SortOrderSchema).optional(),
  brand_name_id: z.lazy(() => SortOrderSchema).optional()
}).strict();
...
export const BrandOriginCountOrderByAggregateInputSchema: z.ZodType<Prisma.BrandOriginCountOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional(),
  createdAt: z.lazy(() => SortOrderSchema).optional(),
  updatedAt: z.lazy(() => SortOrderSchema).optional()
...
export const BrandOriginMaxOrderByAggregateInputSchema: z.ZodType<Prisma.BrandOriginMaxOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional(),
  createdAt: z.lazy(() => SortOrderSchema).optional(),
  updatedAt: z.lazy(() => SortOrderSchema).optional()
...
export const BrandOriginMinOrderByAggregateInputSchema: z.ZodType<Prisma.BrandOriginMinOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional(),
  createdAt: z.lazy(() => SortOrderSchema).optional(),
  updatedAt: z.lazy(() => SortOrderSchema).optional()
...
export const BrandNameCountOrderByAggregateInputSchema: z.ZodType<Prisma.BrandNameCountOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional(),
  createdAt: z.lazy(() => SortOrderSchema).optional(),
  updatedAt: z.lazy(() => SortOrderSchema).optional()
...
export const BrandNameMaxOrderByAggregateInputSchema: z.ZodType<Prisma.BrandNameMaxOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional(),
  createdAt: z.lazy(() => SortOrderSchema).optional(),
  updatedAt: z.lazy(() => SortOrderSchema).optional()
...
export const BrandNameMinOrderByAggregateInputSchema: z.ZodType<Prisma.BrandNameMinOrderByAggregateInput> = z.object({
  id: z.lazy(() => SortOrderSchema).optional(),
  name: z.lazy(() => SortOrderSchema).optional(),
  createdAt: z.lazy(() => SortOrderSchema).optional(),
  updatedAt: z.lazy(() => SortOrderSchema).optional()
...
export const StatusOrderRelationFilterSchema: z.ZodType<Prisma.StatusOrderRelationFilter> = z.object({
  is: z.lazy(() => StatusOrderWhereInputSchema).optional(),
  isNot: z.lazy(() => StatusOrderWhereInputSchema).optional()
}).strict();
...
export const WardsCreateNestedOneWithoutAddressInputSchema: z.ZodType<Prisma.WardsCreateNestedOneWithoutAddressInput> = z.object({
  create: z.union([ z.lazy(() => WardsCreateWithoutAddressInputSchema),z.lazy(() => WardsUncheckedCreateWithoutAddressInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => WardsCreateOrConnectWithoutAddressInputSchema).optional(),
  connect: z.lazy(() => WardsWhereUniqueInputSchema).optional()
}).strict();
...
export const ProvinceUpdateOneRequiredWithoutAddressNestedInputSchema: z.ZodType<Prisma.ProvinceUpdateOneRequiredWithoutAddressNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProvinceCreateWithoutAddressInputSchema),z.lazy(() => ProvinceUncheckedCreateWithoutAddressInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => ProvinceCreateOrConnectWithoutAddressInputSchema).optional(),
  upsert: z.lazy(() => ProvinceUpsertWithoutAddressInputSchema).optional(),
  connect: z.lazy(() => ProvinceWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => ProvinceUpdateToOneWithWhereWithoutAddressInputSchema),z.lazy(() => ProvinceUpdateWithoutAddressInputSchema),z.lazy(() => ProvinceUncheckedUpdateWithoutAddressInputSchema) ]).optional(),
}).strict();

export const DistrictUpdateOneRequiredWithoutAddressNestedInputSchema: z.ZodType<Prisma.DistrictUpdateOneRequiredWithoutAddressNestedInput> = z.object({
  create: z.union([ z.lazy(() => DistrictCreateWithoutAddressInputSchema),z.lazy(() => DistrictUncheckedCreateWithoutAddressInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => DistrictCreateOrConnectWithoutAddressInputSchema).optional(),
  upsert: z.lazy(() => DistrictUpsertWithoutAddressInputSchema).optional(),
  connect: z.lazy(() => DistrictWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => DistrictUpdateToOneWithWhereWithoutAddressInputSchema),z.lazy(() => DistrictUpdateWithoutAddressInputSchema),z.lazy(() => DistrictUncheckedUpdateWithoutAddressInputSchema) ]).optional(),
}).strict();

export const WardsUpdateOneRequiredWithoutAddressNestedInputSchema: z.ZodType<Prisma.WardsUpdateOneRequiredWithoutAddressNestedInput> = z.object({
  create: z.union([ z.lazy(() => WardsCreateWithoutAddressInputSchema),z.lazy(() => WardsUncheckedCreateWithoutAddressInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => WardsCreateOrConnectWithoutAddressInputSchema).optional(),
  upsert: z.lazy(() => WardsUpsertWithoutAddressInputSchema).optional(),
  connect: z.lazy(() => WardsWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => WardsUpdateToOneWithWhereWithoutAddressInputSchema),z.lazy(() => WardsUpdateWithoutAddressInputSchema),z.lazy(() => WardsUncheckedUpdateWithoutAddressInputSchema) ]).optional(),
}).strict();
...
export const WardsCreateNestedManyWithoutDistrictInputSchema: z.ZodType<Prisma.WardsCreateNestedManyWithoutDistrictInput> = z.object({
  create: z.union([ z.lazy(() => WardsCreateWithoutDistrictInputSchema),z.lazy(() => WardsCreateWithoutDistrictInputSchema).array(),z.lazy(() => WardsUncheckedCreateWithoutDistrictInputSchema),z.lazy(() => WardsUncheckedCreateWithoutDistrictInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => WardsCreateOrConnectWithoutDistrictInputSchema),z.lazy(() => WardsCreateOrConnectWithoutDistrictInputSchema).array() ]).optional(),
  createMany: z.lazy(() => WardsCreateManyDistrictInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => WardsWhereUniqueInputSchema),z.lazy(() => WardsWhereUniqueInputSchema).array() ]).optional(),
}).strict();
...
export const WardsUncheckedCreateNestedManyWithoutDistrictInputSchema: z.ZodType<Prisma.WardsUncheckedCreateNestedManyWithoutDistrictInput> = z.object({
  create: z.union([ z.lazy(() => WardsCreateWithoutDistrictInputSchema),z.lazy(() => WardsCreateWithoutDistrictInputSchema).array(),z.lazy(() => WardsUncheckedCreateWithoutDistrictInputSchema),z.lazy(() => WardsUncheckedCreateWithoutDistrictInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => WardsCreateOrConnectWithoutDistrictInputSchema),z.lazy(() => WardsCreateOrConnectWithoutDistrictInputSchema).array() ]).optional(),
  createMany: z.lazy(() => WardsCreateManyDistrictInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => WardsWhereUniqueInputSchema),z.lazy(() => WardsWhereUniqueInputSchema).array() ]).optional(),
...
export const ProvinceUpdateOneWithoutDistrictsNestedInputSchema: z.ZodType<Prisma.ProvinceUpdateOneWithoutDistrictsNestedInput> = z.object({
  ...
  disconnect: z.union([ z.boolean(),z.lazy(() => ProvinceWhereInputSchema) ]).optional(),
  delete: z.union([ z.boolean(),z.lazy(() => ProvinceWhereInputSchema) ]).optional(),
  connect: z.lazy(() => ProvinceWhereUniqueInputSchema).optional(),
...
export const WardsUpdateManyWithoutDistrictNestedInputSchema: z.ZodType<Prisma.WardsUpdateManyWithoutDistrictNestedInput> = z.object({
  create: z.union([ z.lazy(() => WardsCreateWithoutDistrictInputSchema),z.lazy(() => WardsCreateWithoutDistrictInputSchema).array(),z.lazy(() => WardsUncheckedCreateWithoutDistrictInputSchema),z.lazy(() => WardsUncheckedCreateWithoutDistrictInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => WardsCreateOrConnectWithoutDistrictInputSchema),z.lazy(() => WardsCreateOrConnectWithoutDistrictInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => WardsUpsertWithWhereUniqueWithoutDistrictInputSchema),z.lazy(() => WardsUpsertWithWhereUniqueWithoutDistrictInputSchema).array() ]).optional(),
  createMany: z.lazy(() => WardsCreateManyDistrictInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => WardsWhereUniqueInputSchema),z.lazy(() => WardsWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => WardsWhereUniqueInputSchema),z.lazy(() => WardsWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => WardsWhereUniqueInputSchema),z.lazy(() => WardsWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => WardsWhereUniqueInputSchema),z.lazy(() => WardsWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => WardsUpdateWithWhereUniqueWithoutDistrictInputSchema),z.lazy(() => WardsUpdateWithWhereUniqueWithoutDistrictInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => WardsUpdateManyWithWhereWithoutDistrictInputSchema),z.lazy(() => WardsUpdateManyWithWhereWithoutDistrictInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => WardsScalarWhereInputSchema),z.lazy(() => WardsScalarWhereInputSchema).array() ]).optional(),
}).strict();
...
export const WardsUncheckedUpdateManyWithoutDistrictNestedInputSchema: z.ZodType<Prisma.WardsUncheckedUpdateManyWithoutDistrictNestedInput> = z.object({
  create: z.union([ z.lazy(() => WardsCreateWithoutDistrictInputSchema),z.lazy(() => WardsCreateWithoutDistrictInputSchema).array(),z.lazy(() => WardsUncheckedCreateWithoutDistrictInputSchema),z.lazy(() => WardsUncheckedCreateWithoutDistrictInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => WardsCreateOrConnectWithoutDistrictInputSchema),z.lazy(() => WardsCreateOrConnectWithoutDistrictInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => WardsUpsertWithWhereUniqueWithoutDistrictInputSchema),z.lazy(() => WardsUpsertWithWhereUniqueWithoutDistrictInputSchema).array() ]).optional(),
  createMany: z.lazy(() => WardsCreateManyDistrictInputEnvelopeSchema).optional(),
...
export const AddressCreateNestedManyWithoutWardsInputSchema: z.ZodType<Prisma.AddressCreateNestedManyWithoutWardsInput> = z.object({
  create: z.union([ z.lazy(() => AddressCreateWithoutWardsInputSchema),z.lazy(() => AddressCreateWithoutWardsInputSchema).array(),z.lazy(() => AddressUncheckedCreateWithoutWardsInputSchema),z.lazy(() => AddressUncheckedCreateWithoutWardsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => AddressCreateOrConnectWithoutWardsInputSchema),z.lazy(() => AddressCreateOrConnectWithoutWardsInputSchema).array() ]).optional(),
  createMany: z.lazy(() => AddressCreateManyWardsInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => AddressWhereUniqueInputSchema),z.lazy(() => AddressWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const AddressUncheckedCreateNestedManyWithoutWardsInputSchema: z.ZodType<Prisma.AddressUncheckedCreateNestedManyWithoutWardsInput> = z.object({
  create: z.union([ z.lazy(() => AddressCreateWithoutWardsInputSchema),z.lazy(() => AddressCreateWithoutWardsInputSchema).array(),z.lazy(() => AddressUncheckedCreateWithoutWardsInputSchema),z.lazy(() => AddressUncheckedCreateWithoutWardsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => AddressCreateOrConnectWithoutWardsInputSchema),z.lazy(() => AddressCreateOrConnectWithoutWardsInputSchema).array() ]).optional(),
  createMany: z.lazy(() => AddressCreateManyWardsInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => AddressWhereUniqueInputSchema),z.lazy(() => AddressWhereUniqueInputSchema).array() ]).optional(),
...
export const DistrictUpdateOneWithoutWardNestedInputSchema: z.ZodType<Prisma.DistrictUpdateOneWithoutWardNestedInput> = z.object({
  ...
  connect: z.lazy(() => DistrictWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => DistrictUpdateToOneWithWhereWithoutWardInputSchema),z.lazy(() => DistrictUpdateWithoutWardInputSchema),z.lazy(() => DistrictUncheckedUpdateWithoutWardInputSchema) ]).optional(),
}).strict();

export const AddressUpdateManyWithoutWardsNestedInputSchema: z.ZodType<Prisma.AddressUpdateManyWithoutWardsNestedInput> = z.object({
  create: z.union([ z.lazy(() => AddressCreateWithoutWardsInputSchema),z.lazy(() => AddressCreateWithoutWardsInputSchema).array(),z.lazy(() => AddressUncheckedCreateWithoutWardsInputSchema),z.lazy(() => AddressUncheckedCreateWithoutWardsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => AddressCreateOrConnectWithoutWardsInputSchema),z.lazy(() => AddressCreateOrConnectWithoutWardsInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => AddressUpsertWithWhereUniqueWithoutWardsInputSchema),z.lazy(() => AddressUpsertWithWhereUniqueWithoutWardsInputSchema).array() ]).optional(),
  createMany: z.lazy(() => AddressCreateManyWardsInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => AddressWhereUniqueInputSchema),z.lazy(() => AddressWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => AddressWhereUniqueInputSchema),z.lazy(() => AddressWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => AddressWhereUniqueInputSchema),z.lazy(() => AddressWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => AddressWhereUniqueInputSchema),z.lazy(() => AddressWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => AddressUpdateWithWhereUniqueWithoutWardsInputSchema),z.lazy(() => AddressUpdateWithWhereUniqueWithoutWardsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => AddressUpdateManyWithWhereWithoutWardsInputSchema),z.lazy(() => AddressUpdateManyWithWhereWithoutWardsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => AddressScalarWhereInputSchema),z.lazy(() => AddressScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const AddressUncheckedUpdateManyWithoutWardsNestedInputSchema: z.ZodType<Prisma.AddressUncheckedUpdateManyWithoutWardsNestedInput> = z.object({
  create: z.union([ z.lazy(() => AddressCreateWithoutWardsInputSchema),z.lazy(() => AddressCreateWithoutWardsInputSchema).array(),z.lazy(() => AddressUncheckedCreateWithoutWardsInputSchema),z.lazy(() => AddressUncheckedCreateWithoutWardsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => AddressCreateOrConnectWithoutWardsInputSchema),z.lazy(() => AddressCreateOrConnectWithoutWardsInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => AddressUpsertWithWhereUniqueWithoutWardsInputSchema),z.lazy(() => AddressUpsertWithWhereUniqueWithoutWardsInputSchema).array() ]).optional(),
  createMany: z.lazy(() => AddressCreateManyWardsInputEnvelopeSchema).optional(),
...
export const BrandOriginCreateNestedOneWithoutProductInputSchema: z.ZodType<Prisma.BrandOriginCreateNestedOneWithoutProductInput> = z.object({
  create: z.union([ z.lazy(() => BrandOriginCreateWithoutProductInputSchema),z.lazy(() => BrandOriginUncheckedCreateWithoutProductInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => BrandOriginCreateOrConnectWithoutProductInputSchema).optional(),
  connect: z.lazy(() => BrandOriginWhereUniqueInputSchema).optional()
}).strict();
...
export const BrandNameCreateNestedOneWithoutProductInputSchema: z.ZodType<Prisma.BrandNameCreateNestedOneWithoutProductInput> = z.object({
  create: z.union([ z.lazy(() => BrandNameCreateWithoutProductInputSchema),z.lazy(() => BrandNameUncheckedCreateWithoutProductInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => BrandNameCreateOrConnectWithoutProductInputSchema).optional(),
  connect: z.lazy(() => BrandNameWhereUniqueInputSchema).optional()
}).strict();
...
export const BrandOriginUpdateOneWithoutProductNestedInputSchema: z.ZodType<Prisma.BrandOriginUpdateOneWithoutProductNestedInput> = z.object({
  create: z.union([ z.lazy(() => BrandOriginCreateWithoutProductInputSchema),z.lazy(() => BrandOriginUncheckedCreateWithoutProductInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => BrandOriginCreateOrConnectWithoutProductInputSchema).optional(),
  upsert: z.lazy(() => BrandOriginUpsertWithoutProductInputSchema).optional(),
  disconnect: z.union([ z.boolean(),z.lazy(() => BrandOriginWhereInputSchema) ]).optional(),
  delete: z.union([ z.boolean(),z.lazy(() => BrandOriginWhereInputSchema) ]).optional(),
  connect: z.lazy(() => BrandOriginWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => BrandOriginUpdateToOneWithWhereWithoutProductInputSchema),z.lazy(() => BrandOriginUpdateWithoutProductInputSchema),z.lazy(() => BrandOriginUncheckedUpdateWithoutProductInputSchema) ]).optional(),
}).strict();
...
export const CategoryUpdateOneWithoutProductNestedInputSchema: z.ZodType<Prisma.CategoryUpdateOneWithoutProductNestedInput> = z.object({
  ...
  connect: z.lazy(() => CategoryWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => CategoryUpdateToOneWithWhereWithoutProductInputSchema),z.lazy(() => CategoryUpdateWithoutProductInputSchema),z.lazy(() => CategoryUncheckedUpdateWithoutProductInputSchema) ]).optional(),
}).strict();

export const BrandNameUpdateOneWithoutProductNestedInputSchema: z.ZodType<Prisma.BrandNameUpdateOneWithoutProductNestedInput> = z.object({
  create: z.union([ z.lazy(() => BrandNameCreateWithoutProductInputSchema),z.lazy(() => BrandNameUncheckedCreateWithoutProductInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => BrandNameCreateOrConnectWithoutProductInputSchema).optional(),
  upsert: z.lazy(() => BrandNameUpsertWithoutProductInputSchema).optional(),
  disconnect: z.union([ z.boolean(),z.lazy(() => BrandNameWhereInputSchema) ]).optional(),
  delete: z.union([ z.boolean(),z.lazy(() => BrandNameWhereInputSchema) ]).optional(),
  connect: z.lazy(() => BrandNameWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => BrandNameUpdateToOneWithWhereWithoutProductInputSchema),z.lazy(() => BrandNameUpdateWithoutProductInputSchema),z.lazy(() => BrandNameUncheckedUpdateWithoutProductInputSchema) ]).optional(),
}).strict();
...
export const ProductUpdateOneWithoutImageNestedInputSchema: z.ZodType<Prisma.ProductUpdateOneWithoutImageNestedInput> = z.object({
  ...
  connect: z.lazy(() => ProductWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => ProductUpdateToOneWithWhereWithoutImageInputSchema),z.lazy(() => ProductUpdateWithoutImageInputSchema),z.lazy(() => ProductUncheckedUpdateWithoutImageInputSchema) ]).optional(),
}).strict();

export const ProductCreateNestedManyWithoutBrandOriginInputSchema: z.ZodType<Prisma.ProductCreateNestedManyWithoutBrandOriginInput> = z.object({
  create: z.union([ z.lazy(() => ProductCreateWithoutBrandOriginInputSchema),z.lazy(() => ProductCreateWithoutBrandOriginInputSchema).array(),z.lazy(() => ProductUncheckedCreateWithoutBrandOriginInputSchema),z.lazy(() => ProductUncheckedCreateWithoutBrandOriginInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProductCreateOrConnectWithoutBrandOriginInputSchema),z.lazy(() => ProductCreateOrConnectWithoutBrandOriginInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ProductCreateManyBrandOriginInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => ProductWhereUniqueInputSchema),z.lazy(() => ProductWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const ProductUncheckedCreateNestedManyWithoutBrandOriginInputSchema: z.ZodType<Prisma.ProductUncheckedCreateNestedManyWithoutBrandOriginInput> = z.object({
  create: z.union([ z.lazy(() => ProductCreateWithoutBrandOriginInputSchema),z.lazy(() => ProductCreateWithoutBrandOriginInputSchema).array(),z.lazy(() => ProductUncheckedCreateWithoutBrandOriginInputSchema),z.lazy(() => ProductUncheckedCreateWithoutBrandOriginInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProductCreateOrConnectWithoutBrandOriginInputSchema),z.lazy(() => ProductCreateOrConnectWithoutBrandOriginInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ProductCreateManyBrandOriginInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => ProductWhereUniqueInputSchema),z.lazy(() => ProductWhereUniqueInputSchema).array() ]).optional(),
...
export const ProductUpdateManyWithoutBrandOriginNestedInputSchema: z.ZodType<Prisma.ProductUpdateManyWithoutBrandOriginNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProductCreateWithoutBrandOriginInputSchema),z.lazy(() => ProductCreateWithoutBrandOriginInputSchema).array(),z.lazy(() => ProductUncheckedCreateWithoutBrandOriginInputSchema),z.lazy(() => ProductUncheckedCreateWithoutBrandOriginInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProductCreateOrConnectWithoutBrandOriginInputSchema),z.lazy(() => ProductCreateOrConnectWithoutBrandOriginInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ProductUpsertWithWhereUniqueWithoutBrandOriginInputSchema),z.lazy(() => ProductUpsertWithWhereUniqueWithoutBrandOriginInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ProductCreateManyBrandOriginInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => ProductWhereUniqueInputSchema),z.lazy(() => ProductWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => ProductWhereUniqueInputSchema),z.lazy(() => ProductWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => ProductWhereUniqueInputSchema),z.lazy(() => ProductWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => ProductWhereUniqueInputSchema),z.lazy(() => ProductWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => ProductUpdateWithWhereUniqueWithoutBrandOriginInputSchema),z.lazy(() => ProductUpdateWithWhereUniqueWithoutBrandOriginInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ProductUpdateManyWithWhereWithoutBrandOriginInputSchema),z.lazy(() => ProductUpdateManyWithWhereWithoutBrandOriginInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ProductScalarWhereInputSchema),z.lazy(() => ProductScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const ProductUncheckedUpdateManyWithoutBrandOriginNestedInputSchema: z.ZodType<Prisma.ProductUncheckedUpdateManyWithoutBrandOriginNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProductCreateWithoutBrandOriginInputSchema),z.lazy(() => ProductCreateWithoutBrandOriginInputSchema).array(),z.lazy(() => ProductUncheckedCreateWithoutBrandOriginInputSchema),z.lazy(() => ProductUncheckedCreateWithoutBrandOriginInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProductCreateOrConnectWithoutBrandOriginInputSchema),z.lazy(() => ProductCreateOrConnectWithoutBrandOriginInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ProductUpsertWithWhereUniqueWithoutBrandOriginInputSchema),z.lazy(() => ProductUpsertWithWhereUniqueWithoutBrandOriginInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ProductCreateManyBrandOriginInputEnvelopeSchema).optional(),
...
export const ProductCreateNestedManyWithoutBrandNameInputSchema: z.ZodType<Prisma.ProductCreateNestedManyWithoutBrandNameInput> = z.object({
  create: z.union([ z.lazy(() => ProductCreateWithoutBrandNameInputSchema),z.lazy(() => ProductCreateWithoutBrandNameInputSchema).array(),z.lazy(() => ProductUncheckedCreateWithoutBrandNameInputSchema),z.lazy(() => ProductUncheckedCreateWithoutBrandNameInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProductCreateOrConnectWithoutBrandNameInputSchema),z.lazy(() => ProductCreateOrConnectWithoutBrandNameInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ProductCreateManyBrandNameInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => ProductWhereUniqueInputSchema),z.lazy(() => ProductWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const ProductUncheckedCreateNestedManyWithoutBrandNameInputSchema: z.ZodType<Prisma.ProductUncheckedCreateNestedManyWithoutBrandNameInput> = z.object({
  create: z.union([ z.lazy(() => ProductCreateWithoutBrandNameInputSchema),z.lazy(() => ProductCreateWithoutBrandNameInputSchema).array(),z.lazy(() => ProductUncheckedCreateWithoutBrandNameInputSchema),z.lazy(() => ProductUncheckedCreateWithoutBrandNameInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProductCreateOrConnectWithoutBrandNameInputSchema),z.lazy(() => ProductCreateOrConnectWithoutBrandNameInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ProductCreateManyBrandNameInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => ProductWhereUniqueInputSchema),z.lazy(() => ProductWhereUniqueInputSchema).array() ]).optional(),
...
export const ProductUpdateManyWithoutBrandNameNestedInputSchema: z.ZodType<Prisma.ProductUpdateManyWithoutBrandNameNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProductCreateWithoutBrandNameInputSchema),z.lazy(() => ProductCreateWithoutBrandNameInputSchema).array(),z.lazy(() => ProductUncheckedCreateWithoutBrandNameInputSchema),z.lazy(() => ProductUncheckedCreateWithoutBrandNameInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProductCreateOrConnectWithoutBrandNameInputSchema),z.lazy(() => ProductCreateOrConnectWithoutBrandNameInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ProductUpsertWithWhereUniqueWithoutBrandNameInputSchema),z.lazy(() => ProductUpsertWithWhereUniqueWithoutBrandNameInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ProductCreateManyBrandNameInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => ProductWhereUniqueInputSchema),z.lazy(() => ProductWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => ProductWhereUniqueInputSchema),z.lazy(() => ProductWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => ProductWhereUniqueInputSchema),z.lazy(() => ProductWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => ProductWhereUniqueInputSchema),z.lazy(() => ProductWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => ProductUpdateWithWhereUniqueWithoutBrandNameInputSchema),z.lazy(() => ProductUpdateWithWhereUniqueWithoutBrandNameInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ProductUpdateManyWithWhereWithoutBrandNameInputSchema),z.lazy(() => ProductUpdateManyWithWhereWithoutBrandNameInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ProductScalarWhereInputSchema),z.lazy(() => ProductScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const ProductUncheckedUpdateManyWithoutBrandNameNestedInputSchema: z.ZodType<Prisma.ProductUncheckedUpdateManyWithoutBrandNameNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProductCreateWithoutBrandNameInputSchema),z.lazy(() => ProductCreateWithoutBrandNameInputSchema).array(),z.lazy(() => ProductUncheckedCreateWithoutBrandNameInputSchema),z.lazy(() => ProductUncheckedCreateWithoutBrandNameInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProductCreateOrConnectWithoutBrandNameInputSchema),z.lazy(() => ProductCreateOrConnectWithoutBrandNameInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ProductUpsertWithWhereUniqueWithoutBrandNameInputSchema),z.lazy(() => ProductUpsertWithWhereUniqueWithoutBrandNameInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ProductCreateManyBrandNameInputEnvelopeSchema).optional(),
...
export const StatusOrderUpdateOneRequiredWithoutOrderNestedInputSchema: z.ZodType<Prisma.StatusOrderUpdateOneRequiredWithoutOrderNestedInput> = z.object({
  ...
  connect: z.lazy(() => StatusOrderWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => StatusOrderUpdateToOneWithWhereWithoutOrderInputSchema),z.lazy(() => StatusOrderUpdateWithoutOrderInputSchema),z.lazy(() => StatusOrderUncheckedUpdateWithoutOrderInputSchema) ]).optional(),
}).strict();
...
export const WardsCreateWithoutAddressInputSchema: z.ZodType<Prisma.WardsCreateWithoutAddressInput> = z.object({
  wards_id: z.string().cuid().optional(),
  name: z.string(),
  District: z.lazy(() => DistrictCreateNestedOneWithoutWardInputSchema).optional()
}).strict();

export const WardsUncheckedCreateWithoutAddressInputSchema: z.ZodType<Prisma.WardsUncheckedCreateWithoutAddressInput> = z.object({
  wards_id: z.string().cuid().optional(),
  district_id: z.string(),
  name: z.string()
}).strict();

export const WardsCreateOrConnectWithoutAddressInputSchema: z.ZodType<Prisma.WardsCreateOrConnectWithoutAddressInput> = z.object({
  where: z.lazy(() => WardsWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => WardsCreateWithoutAddressInputSchema),z.lazy(() => WardsUncheckedCreateWithoutAddressInputSchema) ]),
}).strict();
...
export const ProvinceUpdateToOneWithWhereWithoutAddressInputSchema: z.ZodType<Prisma.ProvinceUpdateToOneWithWhereWithoutAddressInput> = z.object({
  where: z.lazy(() => ProvinceWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => ProvinceUpdateWithoutAddressInputSchema),z.lazy(() => ProvinceUncheckedUpdateWithoutAddressInputSchema) ]),
}).strict();
...
export const DistrictUpdateToOneWithWhereWithoutAddressInputSchema: z.ZodType<Prisma.DistrictUpdateToOneWithWhereWithoutAddressInput> = z.object({
  where: z.lazy(() => DistrictWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => DistrictUpdateWithoutAddressInputSchema),z.lazy(() => DistrictUncheckedUpdateWithoutAddressInputSchema) ]),
}).strict();
...
export const WardsUpsertWithoutAddressInputSchema: z.ZodType<Prisma.WardsUpsertWithoutAddressInput> = z.object({
  update: z.union([ z.lazy(() => WardsUpdateWithoutAddressInputSchema),z.lazy(() => WardsUncheckedUpdateWithoutAddressInputSchema) ]),
  create: z.union([ z.lazy(() => WardsCreateWithoutAddressInputSchema),z.lazy(() => WardsUncheckedCreateWithoutAddressInputSchema) ]),
  where: z.lazy(() => WardsWhereInputSchema).optional()
}).strict();

export const WardsUpdateToOneWithWhereWithoutAddressInputSchema: z.ZodType<Prisma.WardsUpdateToOneWithWhereWithoutAddressInput> = z.object({
  where: z.lazy(() => WardsWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => WardsUpdateWithoutAddressInputSchema),z.lazy(() => WardsUncheckedUpdateWithoutAddressInputSchema) ]),
}).strict();

export const WardsUpdateWithoutAddressInputSchema: z.ZodType<Prisma.WardsUpdateWithoutAddressInput> = z.object({
  wards_id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  District: z.lazy(() => DistrictUpdateOneWithoutWardNestedInputSchema).optional()
}).strict();

export const WardsUncheckedUpdateWithoutAddressInputSchema: z.ZodType<Prisma.WardsUncheckedUpdateWithoutAddressInput> = z.object({
  wards_id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  district_id: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();
...
export const WardsCreateWithoutDistrictInputSchema: z.ZodType<Prisma.WardsCreateWithoutDistrictInput> = z.object({
  wards_id: z.string().cuid().optional(),
  name: z.string(),
  Address: z.lazy(() => AddressCreateNestedManyWithoutWardsInputSchema).optional()
}).strict();

export const WardsUncheckedCreateWithoutDistrictInputSchema: z.ZodType<Prisma.WardsUncheckedCreateWithoutDistrictInput> = z.object({
  wards_id: z.string().cuid().optional(),
  name: z.string(),
  Address: z.lazy(() => AddressUncheckedCreateNestedManyWithoutWardsInputSchema).optional()
}).strict();

export const WardsCreateOrConnectWithoutDistrictInputSchema: z.ZodType<Prisma.WardsCreateOrConnectWithoutDistrictInput> = z.object({
  where: z.lazy(() => WardsWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => WardsCreateWithoutDistrictInputSchema),z.lazy(() => WardsUncheckedCreateWithoutDistrictInputSchema) ]),
}).strict();

export const WardsCreateManyDistrictInputEnvelopeSchema: z.ZodType<Prisma.WardsCreateManyDistrictInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => WardsCreateManyDistrictInputSchema),z.lazy(() => WardsCreateManyDistrictInputSchema).array() ]),
  skipDuplicates: z.boolean().optional()
}).strict();
...
export const WardsUpsertWithWhereUniqueWithoutDistrictInputSchema: z.ZodType<Prisma.WardsUpsertWithWhereUniqueWithoutDistrictInput> = z.object({
  where: z.lazy(() => WardsWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => WardsUpdateWithoutDistrictInputSchema),z.lazy(() => WardsUncheckedUpdateWithoutDistrictInputSchema) ]),
  create: z.union([ z.lazy(() => WardsCreateWithoutDistrictInputSchema),z.lazy(() => WardsUncheckedCreateWithoutDistrictInputSchema) ]),
}).strict();

export const WardsUpdateWithWhereUniqueWithoutDistrictInputSchema: z.ZodType<Prisma.WardsUpdateWithWhereUniqueWithoutDistrictInput> = z.object({
  where: z.lazy(() => WardsWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => WardsUpdateWithoutDistrictInputSchema),z.lazy(() => WardsUncheckedUpdateWithoutDistrictInputSchema) ]),
}).strict();

export const WardsUpdateManyWithWhereWithoutDistrictInputSchema: z.ZodType<Prisma.WardsUpdateManyWithWhereWithoutDistrictInput> = z.object({
  where: z.lazy(() => WardsScalarWhereInputSchema),
  data: z.union([ z.lazy(() => WardsUpdateManyMutationInputSchema),z.lazy(() => WardsUncheckedUpdateManyWithoutDistrictInputSchema) ]),
}).strict();

export const WardsScalarWhereInputSchema: z.ZodType<Prisma.WardsScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => WardsScalarWhereInputSchema),z.lazy(() => WardsScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => WardsScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => WardsScalarWhereInputSchema),z.lazy(() => WardsScalarWhereInputSchema).array() ]).optional(),
  wards_id: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  district_id: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  name: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
}).strict();
...
export const AddressUpdateManyWithWhereWithoutDistrictInputSchema: z.ZodType<Prisma.AddressUpdateManyWithWhereWithoutDistrictInput> = z.object({
  where: z.lazy(() => AddressScalarWhereInputSchema),
  data: z.union([ z.lazy(() => AddressUpdateManyMutationInputSchema),z.lazy(() => AddressUncheckedUpdateManyWithoutDistrictInputSchema) ]),
}).strict();
...
export const AddressUpdateManyWithWhereWithoutProvinceInputSchema: z.ZodType<Prisma.AddressUpdateManyWithWhereWithoutProvinceInput> = z.object({
  where: z.lazy(() => AddressScalarWhereInputSchema),
  data: z.union([ z.lazy(() => AddressUpdateManyMutationInputSchema),z.lazy(() => AddressUncheckedUpdateManyWithoutProvinceInputSchema) ]),
}).strict();
...
export const AddressCreateWithoutWardsInputSchema: z.ZodType<Prisma.AddressCreateWithoutWardsInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  phone_number: z.string(),
  address_detail: z.string(),
...
export const AddressUncheckedCreateWithoutWardsInputSchema: z.ZodType<Prisma.AddressUncheckedCreateWithoutWardsInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  phone_number: z.string(),
  address_detail: z.string(),
...
export const AddressCreateOrConnectWithoutWardsInputSchema: z.ZodType<Prisma.AddressCreateOrConnectWithoutWardsInput> = z.object({
  where: z.lazy(() => AddressWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => AddressCreateWithoutWardsInputSchema),z.lazy(() => AddressUncheckedCreateWithoutWardsInputSchema) ]),
}).strict();

export const AddressCreateManyWardsInputEnvelopeSchema: z.ZodType<Prisma.AddressCreateManyWardsInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => AddressCreateManyWardsInputSchema),z.lazy(() => AddressCreateManyWardsInputSchema).array() ]),
  skipDuplicates: z.boolean().optional()
}).strict();
...
export const DistrictUpdateToOneWithWhereWithoutWardInputSchema: z.ZodType<Prisma.DistrictUpdateToOneWithWhereWithoutWardInput> = z.object({
  where: z.lazy(() => DistrictWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => DistrictUpdateWithoutWardInputSchema),z.lazy(() => DistrictUncheckedUpdateWithoutWardInputSchema) ]),
}).strict();
...
export const AddressUpsertWithWhereUniqueWithoutWardsInputSchema: z.ZodType<Prisma.AddressUpsertWithWhereUniqueWithoutWardsInput> = z.object({
  where: z.lazy(() => AddressWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => AddressUpdateWithoutWardsInputSchema),z.lazy(() => AddressUncheckedUpdateWithoutWardsInputSchema) ]),
  create: z.union([ z.lazy(() => AddressCreateWithoutWardsInputSchema),z.lazy(() => AddressUncheckedCreateWithoutWardsInputSchema) ]),
}).strict();

export const AddressUpdateWithWhereUniqueWithoutWardsInputSchema: z.ZodType<Prisma.AddressUpdateWithWhereUniqueWithoutWardsInput> = z.object({
  where: z.lazy(() => AddressWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => AddressUpdateWithoutWardsInputSchema),z.lazy(() => AddressUncheckedUpdateWithoutWardsInputSchema) ]),
}).strict();

export const AddressUpdateManyWithWhereWithoutWardsInputSchema: z.ZodType<Prisma.AddressUpdateManyWithWhereWithoutWardsInput> = z.object({
  where: z.lazy(() => AddressScalarWhereInputSchema),
  data: z.union([ z.lazy(() => AddressUpdateManyMutationInputSchema),z.lazy(() => AddressUncheckedUpdateManyWithoutWardsInputSchema) ]),
}).strict();
...
export const BrandOriginCreateWithoutProductInputSchema: z.ZodType<Prisma.BrandOriginCreateWithoutProductInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional()
...
export const BrandOriginUncheckedCreateWithoutProductInputSchema: z.ZodType<Prisma.BrandOriginUncheckedCreateWithoutProductInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional()
...
export const BrandOriginCreateOrConnectWithoutProductInputSchema: z.ZodType<Prisma.BrandOriginCreateOrConnectWithoutProductInput> = z.object({
  where: z.lazy(() => BrandOriginWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => BrandOriginCreateWithoutProductInputSchema),z.lazy(() => BrandOriginUncheckedCreateWithoutProductInputSchema) ]),
}).strict();
...
export const BrandNameCreateWithoutProductInputSchema: z.ZodType<Prisma.BrandNameCreateWithoutProductInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional()
...
export const BrandNameUncheckedCreateWithoutProductInputSchema: z.ZodType<Prisma.BrandNameUncheckedCreateWithoutProductInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional()
...
export const BrandNameCreateOrConnectWithoutProductInputSchema: z.ZodType<Prisma.BrandNameCreateOrConnectWithoutProductInput> = z.object({
  where: z.lazy(() => BrandNameWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => BrandNameCreateWithoutProductInputSchema),z.lazy(() => BrandNameUncheckedCreateWithoutProductInputSchema) ]),
}).strict();
...
export const ImageProductUpdateManyWithWhereWithoutProductInputSchema: z.ZodType<Prisma.ImageProductUpdateManyWithWhereWithoutProductInput> = z.object({
  ...
  data: z.union([ z.lazy(() => ImageProductUpdateManyMutationInputSchema),z.lazy(() => ImageProductUncheckedUpdateManyWithoutProductInputSchema) ]),
}).strict();
...
export const BrandOriginUpsertWithoutProductInputSchema: z.ZodType<Prisma.BrandOriginUpsertWithoutProductInput> = z.object({
  update: z.union([ z.lazy(() => BrandOriginUpdateWithoutProductInputSchema),z.lazy(() => BrandOriginUncheckedUpdateWithoutProductInputSchema) ]),
  create: z.union([ z.lazy(() => BrandOriginCreateWithoutProductInputSchema),z.lazy(() => BrandOriginUncheckedCreateWithoutProductInputSchema) ]),
  where: z.lazy(() => BrandOriginWhereInputSchema).optional()
}).strict();

export const BrandOriginUpdateToOneWithWhereWithoutProductInputSchema: z.ZodType<Prisma.BrandOriginUpdateToOneWithWhereWithoutProductInput> = z.object({
  where: z.lazy(() => BrandOriginWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => BrandOriginUpdateWithoutProductInputSchema),z.lazy(() => BrandOriginUncheckedUpdateWithoutProductInputSchema) ]),
}).strict();

export const BrandOriginUpdateWithoutProductInputSchema: z.ZodType<Prisma.BrandOriginUpdateWithoutProductInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const BrandOriginUncheckedUpdateWithoutProductInputSchema: z.ZodType<Prisma.BrandOriginUncheckedUpdateWithoutProductInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const CategoryUpdateToOneWithWhereWithoutProductInputSchema: z.ZodType<Prisma.CategoryUpdateToOneWithWhereWithoutProductInput> = z.object({
  where: z.lazy(() => CategoryWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => CategoryUpdateWithoutProductInputSchema),z.lazy(() => CategoryUncheckedUpdateWithoutProductInputSchema) ]),
}).strict();
...
export const BrandNameUpsertWithoutProductInputSchema: z.ZodType<Prisma.BrandNameUpsertWithoutProductInput> = z.object({
  update: z.union([ z.lazy(() => BrandNameUpdateWithoutProductInputSchema),z.lazy(() => BrandNameUncheckedUpdateWithoutProductInputSchema) ]),
  create: z.union([ z.lazy(() => BrandNameCreateWithoutProductInputSchema),z.lazy(() => BrandNameUncheckedCreateWithoutProductInputSchema) ]),
  where: z.lazy(() => BrandNameWhereInputSchema).optional()
}).strict();

export const BrandNameUpdateToOneWithWhereWithoutProductInputSchema: z.ZodType<Prisma.BrandNameUpdateToOneWithWhereWithoutProductInput> = z.object({
  where: z.lazy(() => BrandNameWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => BrandNameUpdateWithoutProductInputSchema),z.lazy(() => BrandNameUncheckedUpdateWithoutProductInputSchema) ]),
}).strict();

export const BrandNameUpdateWithoutProductInputSchema: z.ZodType<Prisma.BrandNameUpdateWithoutProductInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const BrandNameUncheckedUpdateWithoutProductInputSchema: z.ZodType<Prisma.BrandNameUncheckedUpdateWithoutProductInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const CartUpdateManyWithWhereWithoutProductInputSchema: z.ZodType<Prisma.CartUpdateManyWithWhereWithoutProductInput> = z.object({
  where: z.lazy(() => CartScalarWhereInputSchema),
  data: z.union([ z.lazy(() => CartUpdateManyMutationInputSchema),z.lazy(() => CartUncheckedUpdateManyWithoutProductInputSchema) ]),
}).strict();
...
export const ProductUpdateToOneWithWhereWithoutImageInputSchema: z.ZodType<Prisma.ProductUpdateToOneWithWhereWithoutImageInput> = z.object({
  where: z.lazy(() => ProductWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => ProductUpdateWithoutImageInputSchema),z.lazy(() => ProductUncheckedUpdateWithoutImageInputSchema) ]),
}).strict();
...
export const ProductCreateWithoutBrandOriginInputSchema: z.ZodType<Prisma.ProductCreateWithoutBrandOriginInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  price: z.number(),
  description: z.string(),
...
export const ProductUncheckedCreateWithoutBrandOriginInputSchema: z.ZodType<Prisma.ProductUncheckedCreateWithoutBrandOriginInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  price: z.number(),
  description: z.string(),
...
export const ProductCreateOrConnectWithoutBrandOriginInputSchema: z.ZodType<Prisma.ProductCreateOrConnectWithoutBrandOriginInput> = z.object({
  where: z.lazy(() => ProductWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => ProductCreateWithoutBrandOriginInputSchema),z.lazy(() => ProductUncheckedCreateWithoutBrandOriginInputSchema) ]),
}).strict();

export const ProductCreateManyBrandOriginInputEnvelopeSchema: z.ZodType<Prisma.ProductCreateManyBrandOriginInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => ProductCreateManyBrandOriginInputSchema),z.lazy(() => ProductCreateManyBrandOriginInputSchema).array() ]),
  skipDuplicates: z.boolean().optional()
}).strict();

export const ProductUpsertWithWhereUniqueWithoutBrandOriginInputSchema: z.ZodType<Prisma.ProductUpsertWithWhereUniqueWithoutBrandOriginInput> = z.object({
  where: z.lazy(() => ProductWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ProductUpdateWithoutBrandOriginInputSchema),z.lazy(() => ProductUncheckedUpdateWithoutBrandOriginInputSchema) ]),
  create: z.union([ z.lazy(() => ProductCreateWithoutBrandOriginInputSchema),z.lazy(() => ProductUncheckedCreateWithoutBrandOriginInputSchema) ]),
}).strict();

export const ProductUpdateWithWhereUniqueWithoutBrandOriginInputSchema: z.ZodType<Prisma.ProductUpdateWithWhereUniqueWithoutBrandOriginInput> = z.object({
  where: z.lazy(() => ProductWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => ProductUpdateWithoutBrandOriginInputSchema),z.lazy(() => ProductUncheckedUpdateWithoutBrandOriginInputSchema) ]),
}).strict();

export const ProductUpdateManyWithWhereWithoutBrandOriginInputSchema: z.ZodType<Prisma.ProductUpdateManyWithWhereWithoutBrandOriginInput> = z.object({
  where: z.lazy(() => ProductScalarWhereInputSchema),
  data: z.union([ z.lazy(() => ProductUpdateManyMutationInputSchema),z.lazy(() => ProductUncheckedUpdateManyWithoutBrandOriginInputSchema) ]),
}).strict();
...
export const ProductCreateWithoutBrandNameInputSchema: z.ZodType<Prisma.ProductCreateWithoutBrandNameInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  price: z.number(),
  description: z.string(),
...
export const ProductUncheckedCreateWithoutBrandNameInputSchema: z.ZodType<Prisma.ProductUncheckedCreateWithoutBrandNameInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  price: z.number(),
  description: z.string(),
...
export const ProductCreateOrConnectWithoutBrandNameInputSchema: z.ZodType<Prisma.ProductCreateOrConnectWithoutBrandNameInput> = z.object({
  where: z.lazy(() => ProductWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => ProductCreateWithoutBrandNameInputSchema),z.lazy(() => ProductUncheckedCreateWithoutBrandNameInputSchema) ]),
}).strict();

export const ProductCreateManyBrandNameInputEnvelopeSchema: z.ZodType<Prisma.ProductCreateManyBrandNameInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => ProductCreateManyBrandNameInputSchema),z.lazy(() => ProductCreateManyBrandNameInputSchema).array() ]),
  skipDuplicates: z.boolean().optional()
}).strict();

export const ProductUpsertWithWhereUniqueWithoutBrandNameInputSchema: z.ZodType<Prisma.ProductUpsertWithWhereUniqueWithoutBrandNameInput> = z.object({
  where: z.lazy(() => ProductWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ProductUpdateWithoutBrandNameInputSchema),z.lazy(() => ProductUncheckedUpdateWithoutBrandNameInputSchema) ]),
  create: z.union([ z.lazy(() => ProductCreateWithoutBrandNameInputSchema),z.lazy(() => ProductUncheckedCreateWithoutBrandNameInputSchema) ]),
}).strict();

export const ProductUpdateWithWhereUniqueWithoutBrandNameInputSchema: z.ZodType<Prisma.ProductUpdateWithWhereUniqueWithoutBrandNameInput> = z.object({
  where: z.lazy(() => ProductWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => ProductUpdateWithoutBrandNameInputSchema),z.lazy(() => ProductUncheckedUpdateWithoutBrandNameInputSchema) ]),
}).strict();

export const ProductUpdateManyWithWhereWithoutBrandNameInputSchema: z.ZodType<Prisma.ProductUpdateManyWithWhereWithoutBrandNameInput> = z.object({
  where: z.lazy(() => ProductScalarWhereInputSchema),
  data: z.union([ z.lazy(() => ProductUpdateManyMutationInputSchema),z.lazy(() => ProductUncheckedUpdateManyWithoutBrandNameInputSchema) ]),
}).strict();
...
export const StatusOrderUpsertWithoutOrderInputSchema: z.ZodType<Prisma.StatusOrderUpsertWithoutOrderInput> = z.object({
  ...
  create: z.union([ z.lazy(() => StatusOrderCreateWithoutOrderInputSchema),z.lazy(() => StatusOrderUncheckedCreateWithoutOrderInputSchema) ]),
  where: z.lazy(() => StatusOrderWhereInputSchema).optional()
}).strict();

export const StatusOrderUpdateToOneWithWhereWithoutOrderInputSchema: z.ZodType<Prisma.StatusOrderUpdateToOneWithWhereWithoutOrderInput> = z.object({
  where: z.lazy(() => StatusOrderWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => StatusOrderUpdateWithoutOrderInputSchema),z.lazy(() => StatusOrderUncheckedUpdateWithoutOrderInputSchema) ]),
}).strict();
...
export const OrderUpdateManyWithWhereWithoutStatusInputSchema: z.ZodType<Prisma.OrderUpdateManyWithWhereWithoutStatusInput> = z.object({
  where: z.lazy(() => OrderScalarWhereInputSchema),
  data: z.union([ z.lazy(() => OrderUpdateManyMutationInputSchema),z.lazy(() => OrderUncheckedUpdateManyWithoutStatusInputSchema) ]),
}).strict();
...
export const WardsCreateManyDistrictInputSchema: z.ZodType<Prisma.WardsCreateManyDistrictInput> = z.object({
  wards_id: z.string().cuid().optional(),
  name: z.string()
}).strict();
...
export const WardsUpdateWithoutDistrictInputSchema: z.ZodType<Prisma.WardsUpdateWithoutDistrictInput> = z.object({
  wards_id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  Address: z.lazy(() => AddressUpdateManyWithoutWardsNestedInputSchema).optional()
}).strict();

export const WardsUncheckedUpdateWithoutDistrictInputSchema: z.ZodType<Prisma.WardsUncheckedUpdateWithoutDistrictInput> = z.object({
  wards_id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  Address: z.lazy(() => AddressUncheckedUpdateManyWithoutWardsNestedInputSchema).optional()
}).strict();

export const WardsUncheckedUpdateManyWithoutDistrictInputSchema: z.ZodType<Prisma.WardsUncheckedUpdateManyWithoutDistrictInput> = z.object({
  wards_id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();
...
export const AddressUncheckedUpdateManyWithoutDistrictInputSchema: z.ZodType<Prisma.AddressUncheckedUpdateManyWithoutDistrictInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  phone_number: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  address_detail: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const AddressUncheckedUpdateManyWithoutProvinceInputSchema: z.ZodType<Prisma.AddressUncheckedUpdateManyWithoutProvinceInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  phone_number: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  address_detail: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const AddressCreateManyWardsInputSchema: z.ZodType<Prisma.AddressCreateManyWardsInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  phone_number: z.string(),
  address_detail: z.string(),
...
export const AddressUpdateWithoutWardsInputSchema: z.ZodType<Prisma.AddressUpdateWithoutWardsInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  phone_number: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  address_detail: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const AddressUncheckedUpdateWithoutWardsInputSchema: z.ZodType<Prisma.AddressUncheckedUpdateWithoutWardsInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  phone_number: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  address_detail: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const AddressUncheckedUpdateManyWithoutWardsInputSchema: z.ZodType<Prisma.AddressUncheckedUpdateManyWithoutWardsInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  phone_number: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  address_detail: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ImageProductUncheckedUpdateManyWithoutProductInputSchema: z.ZodType<Prisma.ImageProductUncheckedUpdateManyWithoutProductInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  url: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const CartUncheckedUpdateManyWithoutProductInputSchema: z.ZodType<Prisma.CartUncheckedUpdateManyWithoutProductInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  user_id: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  quantity: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ProductCreateManyBrandOriginInputSchema: z.ZodType<Prisma.ProductCreateManyBrandOriginInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  price: z.number(),
  description: z.string(),
...
export const ProductUpdateWithoutBrandOriginInputSchema: z.ZodType<Prisma.ProductUpdateWithoutBrandOriginInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  price: z.union([ z.number(),z.lazy(() => FloatFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ProductUncheckedUpdateWithoutBrandOriginInputSchema: z.ZodType<Prisma.ProductUncheckedUpdateWithoutBrandOriginInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  price: z.union([ z.number(),z.lazy(() => FloatFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ProductUncheckedUpdateManyWithoutBrandOriginInputSchema: z.ZodType<Prisma.ProductUncheckedUpdateManyWithoutBrandOriginInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  price: z.union([ z.number(),z.lazy(() => FloatFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ProductCreateManyBrandNameInputSchema: z.ZodType<Prisma.ProductCreateManyBrandNameInput> = z.object({
  id: z.string().cuid().optional(),
  name: z.string(),
  price: z.number(),
  description: z.string(),
...
export const ProductUpdateWithoutBrandNameInputSchema: z.ZodType<Prisma.ProductUpdateWithoutBrandNameInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  price: z.union([ z.number(),z.lazy(() => FloatFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ProductUncheckedUpdateWithoutBrandNameInputSchema: z.ZodType<Prisma.ProductUncheckedUpdateWithoutBrandNameInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  price: z.union([ z.number(),z.lazy(() => FloatFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ProductUncheckedUpdateManyWithoutBrandNameInputSchema: z.ZodType<Prisma.ProductUncheckedUpdateManyWithoutBrandNameInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  price: z.union([ z.number(),z.lazy(() => FloatFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const OrderUncheckedUpdateManyWithoutStatusInputSchema: z.ZodType<Prisma.OrderUncheckedUpdateManyWithoutStatusInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  user_id: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  product_id: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  quantity: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
...
export const WardsFindFirstArgsSchema: z.ZodType<Prisma.WardsFindFirstArgs> = z.object({
  select: WardsSelectSchema.optional(),
  include: WardsIncludeSchema.optional(),
  where: WardsWhereInputSchema.optional(),
  orderBy: z.union([ WardsOrderByWithRelationInputSchema.array(),WardsOrderByWithRelationInputSchema ]).optional(),
  cursor: WardsWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ WardsScalarFieldEnumSchema,WardsScalarFieldEnumSchema.array() ]).optional(),
}).strict()

export const WardsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.WardsFindFirstOrThrowArgs> = z.object({
  select: WardsSelectSchema.optional(),
  include: WardsIncludeSchema.optional(),
  where: WardsWhereInputSchema.optional(),
  orderBy: z.union([ WardsOrderByWithRelationInputSchema.array(),WardsOrderByWithRelationInputSchema ]).optional(),
...
export const WardsFindManyArgsSchema: z.ZodType<Prisma.WardsFindManyArgs> = z.object({
  select: WardsSelectSchema.optional(),
  include: WardsIncludeSchema.optional(),
  where: WardsWhereInputSchema.optional(),
  orderBy: z.union([ WardsOrderByWithRelationInputSchema.array(),WardsOrderByWithRelationInputSchema ]).optional(),
...
export const WardsAggregateArgsSchema: z.ZodType<Prisma.WardsAggregateArgs> = z.object({
  where: WardsWhereInputSchema.optional(),
  orderBy: z.union([ WardsOrderByWithRelationInputSchema.array(),WardsOrderByWithRelationInputSchema ]).optional(),
  cursor: WardsWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
...
export const WardsGroupByArgsSchema: z.ZodType<Prisma.WardsGroupByArgs> = z.object({
  where: WardsWhereInputSchema.optional(),
  orderBy: z.union([ WardsOrderByWithAggregationInputSchema.array(),WardsOrderByWithAggregationInputSchema ]).optional(),
  by: WardsScalarFieldEnumSchema.array(),
  having: WardsScalarWhereWithAggregatesInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
}).strict()

export const WardsFindUniqueArgsSchema: z.ZodType<Prisma.WardsFindUniqueArgs> = z.object({
  select: WardsSelectSchema.optional(),
  include: WardsIncludeSchema.optional(),
  where: WardsWhereUniqueInputSchema,
}).strict()

export const WardsFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.WardsFindUniqueOrThrowArgs> = z.object({
  select: WardsSelectSchema.optional(),
  include: WardsIncludeSchema.optional(),
  where: WardsWhereUniqueInputSchema,
}).strict()
...
export const BrandOriginFindFirstArgsSchema: z.ZodType<Prisma.BrandOriginFindFirstArgs> = z.object({
  select: BrandOriginSelectSchema.optional(),
  include: BrandOriginIncludeSchema.optional(),
  where: BrandOriginWhereInputSchema.optional(),
  orderBy: z.union([ BrandOriginOrderByWithRelationInputSchema.array(),BrandOriginOrderByWithRelationInputSchema ]).optional(),
  cursor: BrandOriginWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ BrandOriginScalarFieldEnumSchema,BrandOriginScalarFieldEnumSchema.array() ]).optional(),
}).strict()

export const BrandOriginFindFirstOrThrowArgsSchema: z.ZodType<Prisma.BrandOriginFindFirstOrThrowArgs> = z.object({
  select: BrandOriginSelectSchema.optional(),
  include: BrandOriginIncludeSchema.optional(),
  where: BrandOriginWhereInputSchema.optional(),
  orderBy: z.union([ BrandOriginOrderByWithRelationInputSchema.array(),BrandOriginOrderByWithRelationInputSchema ]).optional(),
...
export const BrandOriginFindManyArgsSchema: z.ZodType<Prisma.BrandOriginFindManyArgs> = z.object({
  select: BrandOriginSelectSchema.optional(),
  include: BrandOriginIncludeSchema.optional(),
  where: BrandOriginWhereInputSchema.optional(),
  orderBy: z.union([ BrandOriginOrderByWithRelationInputSchema.array(),BrandOriginOrderByWithRelationInputSchema ]).optional(),
...
export const BrandOriginAggregateArgsSchema: z.ZodType<Prisma.BrandOriginAggregateArgs> = z.object({
  where: BrandOriginWhereInputSchema.optional(),
  orderBy: z.union([ BrandOriginOrderByWithRelationInputSchema.array(),BrandOriginOrderByWithRelationInputSchema ]).optional(),
  cursor: BrandOriginWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
...
export const BrandOriginGroupByArgsSchema: z.ZodType<Prisma.BrandOriginGroupByArgs> = z.object({
  where: BrandOriginWhereInputSchema.optional(),
  orderBy: z.union([ BrandOriginOrderByWithAggregationInputSchema.array(),BrandOriginOrderByWithAggregationInputSchema ]).optional(),
  by: BrandOriginScalarFieldEnumSchema.array(),
  having: BrandOriginScalarWhereWithAggregatesInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
}).strict()

export const BrandOriginFindUniqueArgsSchema: z.ZodType<Prisma.BrandOriginFindUniqueArgs> = z.object({
  select: BrandOriginSelectSchema.optional(),
  include: BrandOriginIncludeSchema.optional(),
  where: BrandOriginWhereUniqueInputSchema,
}).strict()

export const BrandOriginFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.BrandOriginFindUniqueOrThrowArgs> = z.object({
  select: BrandOriginSelectSchema.optional(),
  include: BrandOriginIncludeSchema.optional(),
  where: BrandOriginWhereUniqueInputSchema,
}).strict()
...
export const BrandNameFindFirstArgsSchema: z.ZodType<Prisma.BrandNameFindFirstArgs> = z.object({
  select: BrandNameSelectSchema.optional(),
  include: BrandNameIncludeSchema.optional(),
  where: BrandNameWhereInputSchema.optional(),
  orderBy: z.union([ BrandNameOrderByWithRelationInputSchema.array(),BrandNameOrderByWithRelationInputSchema ]).optional(),
  cursor: BrandNameWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ BrandNameScalarFieldEnumSchema,BrandNameScalarFieldEnumSchema.array() ]).optional(),
}).strict()

export const BrandNameFindFirstOrThrowArgsSchema: z.ZodType<Prisma.BrandNameFindFirstOrThrowArgs> = z.object({
  select: BrandNameSelectSchema.optional(),
  include: BrandNameIncludeSchema.optional(),
  where: BrandNameWhereInputSchema.optional(),
  orderBy: z.union([ BrandNameOrderByWithRelationInputSchema.array(),BrandNameOrderByWithRelationInputSchema ]).optional(),
...
export const BrandNameFindManyArgsSchema: z.ZodType<Prisma.BrandNameFindManyArgs> = z.object({
  select: BrandNameSelectSchema.optional(),
  include: BrandNameIncludeSchema.optional(),
  where: BrandNameWhereInputSchema.optional(),
  orderBy: z.union([ BrandNameOrderByWithRelationInputSchema.array(),BrandNameOrderByWithRelationInputSchema ]).optional(),
...
export const BrandNameAggregateArgsSchema: z.ZodType<Prisma.BrandNameAggregateArgs> = z.object({
  where: BrandNameWhereInputSchema.optional(),
  orderBy: z.union([ BrandNameOrderByWithRelationInputSchema.array(),BrandNameOrderByWithRelationInputSchema ]).optional(),
  cursor: BrandNameWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
...
export const BrandNameGroupByArgsSchema: z.ZodType<Prisma.BrandNameGroupByArgs> = z.object({
  where: BrandNameWhereInputSchema.optional(),
  orderBy: z.union([ BrandNameOrderByWithAggregationInputSchema.array(),BrandNameOrderByWithAggregationInputSchema ]).optional(),
  by: BrandNameScalarFieldEnumSchema.array(),
  having: BrandNameScalarWhereWithAggregatesInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
}).strict()

export const BrandNameFindUniqueArgsSchema: z.ZodType<Prisma.BrandNameFindUniqueArgs> = z.object({
  select: BrandNameSelectSchema.optional(),
  include: BrandNameIncludeSchema.optional(),
  where: BrandNameWhereUniqueInputSchema,
}).strict()

export const BrandNameFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.BrandNameFindUniqueOrThrowArgs> = z.object({
  select: BrandNameSelectSchema.optional(),
  include: BrandNameIncludeSchema.optional(),
  where: BrandNameWhereUniqueInputSchema,
}).strict()
...
export const WardsCreateArgsSchema: z.ZodType<Prisma.WardsCreateArgs> = z.object({
  select: WardsSelectSchema.optional(),
  include: WardsIncludeSchema.optional(),
  data: z.union([ WardsCreateInputSchema,WardsUncheckedCreateInputSchema ]),
}).strict()

export const WardsUpsertArgsSchema: z.ZodType<Prisma.WardsUpsertArgs> = z.object({
  select: WardsSelectSchema.optional(),
  include: WardsIncludeSchema.optional(),
  where: WardsWhereUniqueInputSchema,
  create: z.union([ WardsCreateInputSchema,WardsUncheckedCreateInputSchema ]),
  update: z.union([ WardsUpdateInputSchema,WardsUncheckedUpdateInputSchema ]),
}).strict()

export const WardsCreateManyArgsSchema: z.ZodType<Prisma.WardsCreateManyArgs> = z.object({
  data: z.union([ WardsCreateManyInputSchema,WardsCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict()

export const WardsDeleteArgsSchema: z.ZodType<Prisma.WardsDeleteArgs> = z.object({
  select: WardsSelectSchema.optional(),
  include: WardsIncludeSchema.optional(),
  where: WardsWhereUniqueInputSchema,
}).strict()

export const WardsUpdateArgsSchema: z.ZodType<Prisma.WardsUpdateArgs> = z.object({
  select: WardsSelectSchema.optional(),
  include: WardsIncludeSchema.optional(),
  data: z.union([ WardsUpdateInputSchema,WardsUncheckedUpdateInputSchema ]),
  where: WardsWhereUniqueInputSchema,
}).strict()

export const WardsUpdateManyArgsSchema: z.ZodType<Prisma.WardsUpdateManyArgs> = z.object({
  data: z.union([ WardsUpdateManyMutationInputSchema,WardsUncheckedUpdateManyInputSchema ]),
  where: WardsWhereInputSchema.optional(),
}).strict()

export const WardsDeleteManyArgsSchema: z.ZodType<Prisma.WardsDeleteManyArgs> = z.object({
  where: WardsWhereInputSchema.optional(),
}).strict()
...
export const BrandOriginCreateArgsSchema: z.ZodType<Prisma.BrandOriginCreateArgs> = z.object({
  select: BrandOriginSelectSchema.optional(),
  include: BrandOriginIncludeSchema.optional(),
  data: z.union([ BrandOriginCreateInputSchema,BrandOriginUncheckedCreateInputSchema ]),
}).strict()

export const BrandOriginUpsertArgsSchema: z.ZodType<Prisma.BrandOriginUpsertArgs> = z.object({
  select: BrandOriginSelectSchema.optional(),
  include: BrandOriginIncludeSchema.optional(),
  where: BrandOriginWhereUniqueInputSchema,
  create: z.union([ BrandOriginCreateInputSchema,BrandOriginUncheckedCreateInputSchema ]),
  update: z.union([ BrandOriginUpdateInputSchema,BrandOriginUncheckedUpdateInputSchema ]),
}).strict()

export const BrandOriginCreateManyArgsSchema: z.ZodType<Prisma.BrandOriginCreateManyArgs> = z.object({
  data: z.union([ BrandOriginCreateManyInputSchema,BrandOriginCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict()

export const BrandOriginDeleteArgsSchema: z.ZodType<Prisma.BrandOriginDeleteArgs> = z.object({
  select: BrandOriginSelectSchema.optional(),
  include: BrandOriginIncludeSchema.optional(),
  where: BrandOriginWhereUniqueInputSchema,
}).strict()

export const BrandOriginUpdateArgsSchema: z.ZodType<Prisma.BrandOriginUpdateArgs> = z.object({
  select: BrandOriginSelectSchema.optional(),
  include: BrandOriginIncludeSchema.optional(),
  data: z.union([ BrandOriginUpdateInputSchema,BrandOriginUncheckedUpdateInputSchema ]),
  where: BrandOriginWhereUniqueInputSchema,
}).strict()

export const BrandOriginUpdateManyArgsSchema: z.ZodType<Prisma.BrandOriginUpdateManyArgs> = z.object({
  data: z.union([ BrandOriginUpdateManyMutationInputSchema,BrandOriginUncheckedUpdateManyInputSchema ]),
  where: BrandOriginWhereInputSchema.optional(),
}).strict()

export const BrandOriginDeleteManyArgsSchema: z.ZodType<Prisma.BrandOriginDeleteManyArgs> = z.object({
  where: BrandOriginWhereInputSchema.optional(),
}).strict()
...
export const BrandNameCreateArgsSchema: z.ZodType<Prisma.BrandNameCreateArgs> = z.object({
  select: BrandNameSelectSchema.optional(),
  include: BrandNameIncludeSchema.optional(),
  data: z.union([ BrandNameCreateInputSchema,BrandNameUncheckedCreateInputSchema ]),
}).strict()

export const BrandNameUpsertArgsSchema: z.ZodType<Prisma.BrandNameUpsertArgs> = z.object({
  select: BrandNameSelectSchema.optional(),
  include: BrandNameIncludeSchema.optional(),
  where: BrandNameWhereUniqueInputSchema,
  create: z.union([ BrandNameCreateInputSchema,BrandNameUncheckedCreateInputSchema ]),
  update: z.union([ BrandNameUpdateInputSchema,BrandNameUncheckedUpdateInputSchema ]),
}).strict()

export const BrandNameCreateManyArgsSchema: z.ZodType<Prisma.BrandNameCreateManyArgs> = z.object({
  data: z.union([ BrandNameCreateManyInputSchema,BrandNameCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict()

export const BrandNameDeleteArgsSchema: z.ZodType<Prisma.BrandNameDeleteArgs> = z.object({
  select: BrandNameSelectSchema.optional(),
  include: BrandNameIncludeSchema.optional(),
  where: BrandNameWhereUniqueInputSchema,
}).strict()

export const BrandNameUpdateArgsSchema: z.ZodType<Prisma.BrandNameUpdateArgs> = z.object({
  select: BrandNameSelectSchema.optional(),
  include: BrandNameIncludeSchema.optional(),
  data: z.union([ BrandNameUpdateInputSchema,BrandNameUncheckedUpdateInputSchema ]),
  where: BrandNameWhereUniqueInputSchema,
}).strict()

export const BrandNameUpdateManyArgsSchema: z.ZodType<Prisma.BrandNameUpdateManyArgs> = z.object({
  data: z.union([ BrandNameUpdateManyMutationInputSchema,BrandNameUncheckedUpdateManyInputSchema ]),
  where: BrandNameWhereInputSchema.optional(),
}).strict()

export const BrandNameDeleteManyArgsSchema: z.ZodType<Prisma.BrandNameDeleteManyArgs> = z.object({
  where: BrandNameWhereInputSchema.optional(),
}).strict()
