  ...
  return (
    <Layout>
      <Stack direction="row" justifyContent="space-between" spacing={3}>
        ...
        >
          <SwiperSlide>
            <Image src={Slide1} alt="slide 1" width={1020} height={266} />
          </SwiperSlide>

          <SwiperSlide>
            <Image src={Slide2} alt="slide 2" width={1020} height={266} />
          </SwiperSlide>

          <SwiperSlide>
            <Image src={Slide3} alt="slide 3" width={1020} height={266} />
          </SwiperSlide>
        </SwiperStyled>
